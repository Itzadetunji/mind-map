			...
			<section className="pt-16 pb-20 px-6 relative overflow-hidden">
				...
				<div className="max-w-5xl mx-auto text-center relative z-10">
					...
					<p className="text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto">
						...
						Plan features, map user flows, and generate documentation—all in one
						place.
					</p>
				...
				<div className="max-w-4xl mx-auto relative">
					...
					<div className="py-16 px-8 md:px-16">
						...
						<p className="text-xl md:text-2xl text-slate-600 dark:text-slate-400 leading-relaxed mt-6">
							...
							developers, and product teams transform ideas into structured mind
							maps—making it easier to visualize, iterate, and ship faster.
						</p>
					</div>
				</div>
			</section>
				...
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
							From initial idea to structured documentation. ProtoMap helps you
							think through every aspect of your product.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						...
						<div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Have a conversation with AI to expand, modify, or dive deeper
								into specific areas of your mind map.
							</p>
						</div>
						...
						<div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Generate professional product documentation from your mind maps.
						...
						<div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Share your mind maps with teammates, stakeholders, or clients
								via secure links. Everyone stays aligned.
							</p>
						</div>
						...
						<div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 hover:shadow-lg transition-shadow">
							...
							<p className="text-slate-600 dark:text-slate-400">
								No learning curve. Start mapping your ideas in seconds with a
								clean, distraction-free interface built for speed.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid md:grid-cols-3 gap-12">
						...
						<div className="text-center">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Watch as AI creates a structured mind map with features, flows,
						...
						<div className="text-center">
							...
							<p className="text-slate-600 dark:text-slate-400">
								Chat with AI to expand areas, reorganize nodes, and export your
				...
				<div className="max-w-4xl mx-auto text-center">
					<div className="bg-gradient-to-br from-primary to-[#0077B6] rounded-3xl p-12 md:p-16 text-white">
						...
						<p className="text-lg text-white/80 mb-8 max-w-xl mx-auto">
							Join thousands of founders and builders who use ProtoMap to plan
							their products.
						</p>
						<Link to="/projects">
							<Button
